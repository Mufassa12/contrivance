...
const DISCOVERY_CATEGORIES = {
  security: {
    ...
    questions: [
      ...
      {
        id: 'security_sizing',
        title: 'Security Sizing & Licensing',
        description: 'Provide sizing details for accurate solution recommendations',
        type: 'vendor_multi',
        categories: [
          {
            key: 'perimeter_sizing',
            name: '🔒 Perimeter Security Sizing',
            vendors: [
              { label: 'Number of office/branch locations: 1-10', value: 'fw_loc_1_10' },
              { label: 'Number of office/branch locations: 11-50', value: 'fw_loc_11_50' },
              { label: 'Number of office/branch locations: 50+', value: 'fw_loc_50plus' },
              { label: 'Estimated WAN bandwidth: < 100 Mbps', value: 'fw_bw_100' },
              { label: 'Estimated WAN bandwidth: 100-1000 Mbps', value: 'fw_bw_1000' },
              { label: 'Estimated WAN bandwidth: > 1 Gbps', value: 'fw_bw_1gbps' },
              { label: 'Annual email security throughput: < 1M messages', value: 'email_1m' },
              { label: 'Annual email security throughput: 1-10M messages', value: 'email_10m' },
              { label: 'Annual email security throughput: > 10M messages', value: 'email_10mplus' },
            ],
          },
          {
            key: 'endpoint_sizing',
            name: '💻 Endpoint Security Sizing',
            vendors: [
              { label: 'Number of endpoints: < 100', value: 'ep_100' },
              { label: 'Number of endpoints: 100-500', value: 'ep_500' },
              { label: 'Number of endpoints: 500-2000', value: 'ep_2000' },
              { label: 'Number of endpoints: 2000-5000', value: 'ep_5000' },
              { label: 'Number of endpoints: > 5000', value: 'ep_5000plus' },
              { label: 'Mobile devices: < 100', value: 'mob_100' },
              { label: 'Mobile devices: 100-1000', value: 'mob_1000' },
              { label: 'Mobile devices: > 1000', value: 'mob_1000plus' },
            ],
          },
          {
            key: 'user_licensing',
            name: '👥 User & License Sizing',
            vendors: [
              { label: 'Number of users: < 100', value: 'users_100' },
              { label: 'Number of users: 100-1000', value: 'users_1000' },
              { label: 'Number of users: 1000-5000', value: 'users_5000' },
              { label: 'Number of users: 5000-10000', value: 'users_10000' },
              { label: 'Number of users: > 10000', value: 'users_10000plus' },
              { label: 'Privileged users needing PAM: < 50', value: 'priv_50' },
              { label: 'Privileged users needing PAM: 50-200', value: 'priv_200' },
              { label: 'Privileged users needing PAM: > 200', value: 'priv_200plus' },
            ],
          },
        ],
        guidingQuestions: [
          'Do you have a CISO/Security leadership budget owned by?',
          'What is your annual security infrastructure budget?',
          'Are you replacing/upgrading existing tools or adding new ones?',
          'What is your budget timeframe for implementation?',
          'Do you have preferred vendor relationships for volume discounts?',
        ],
      },
    ],
  },
  infrastructure: {
    ...
    questions: [
      ...
      {
        id: 'infrastructure_sizing',
        title: 'Infrastructure Sizing & Capacity',
        description: 'Provide infrastructure sizing for accurate recommendations',
        type: 'vendor_multi',
        categories: [
          {
            key: 'cloud_sizing',
            name: '☁️ Cloud & Compute Sizing',
            vendors: [
              { label: 'Number of cloud accounts: 1-5', value: 'acct_5' },
              { label: 'Number of cloud accounts: 5-20', value: 'acct_20' },
              { label: 'Number of cloud accounts: 20+', value: 'acct_20plus' },
              { label: 'Monthly cloud spend: < $10k', value: 'spend_10k' },
              { label: 'Monthly cloud spend: $10k-$50k', value: 'spend_50k' },
              { label: 'Monthly cloud spend: $50k-$500k', value: 'spend_500k' },
              { label: 'Monthly cloud spend: > $500k', value: 'spend_500kplus' },
              { label: 'Number of VM instances/services: < 100', value: 'vms_100' },
              { label: 'Number of VM instances/services: 100-500', value: 'vms_500' },
              { label: 'Number of VM instances/services: > 500', value: 'vms_500plus' },
            ],
          },
          {
            key: 'container_sizing',
            name: '🐳 Container & K8s Sizing',
            vendors: [
              { label: 'Number of K8s clusters: 1-3', value: 'k8s_3' },
              { label: 'Number of K8s clusters: 3-10', value: 'k8s_10' },
              { label: 'Number of K8s clusters: 10+', value: 'k8s_10plus' },
              { label: 'Total container nodes: < 50', value: 'nodes_50' },
              { label: 'Total container nodes: 50-200', value: 'nodes_200' },
              { label: 'Total container nodes: > 200', value: 'nodes_200plus' },
              { label: 'Running containers/pods daily: < 100', value: 'pods_100' },
              { label: 'Running containers/pods daily: 100-1000', value: 'pods_1000' },
              { label: 'Running containers/pods daily: > 1000', value: 'pods_1000plus' },
            ],
          },
          {
            key: 'iac_sizing',
            name: '🤖 Infrastructure as Code Sizing',
            vendors: [
              { label: 'Infrastructure resources managed: < 100', value: 'infra_100' },
              { label: 'Infrastructure resources managed: 100-500', value: 'infra_500' },
              { label: 'Infrastructure resources managed: 500-2000', value: 'infra_2000' },
              { label: 'Infrastructure resources managed: > 2000', value: 'infra_2000plus' },
              { label: 'Number of IaC code repos: < 5', value: 'repos_5' },
              { label: 'Number of IaC code repos: 5-20', value: 'repos_20' },
              { label: 'Number of IaC code repos: > 20', value: 'repos_20plus' },
            ],
          },
          {
            key: 'database_sizing',
            name: '📊 Database & Storage Sizing',
            vendors: [
              { label: 'Database instances: < 10', value: 'db_10' },
              { label: 'Database instances: 10-50', value: 'db_50' },
              { label: 'Database instances: > 50', value: 'db_50plus' },
              { label: 'Total data storage: < 1 TB', value: 'storage_1tb' },
              { label: 'Total data storage: 1-10 TB', value: 'storage_10tb' },
              { label: 'Total data storage: 10-100 TB', value: 'storage_100tb' },
              { label: 'Total data storage: > 100 TB', value: 'storage_100tbplus' },
            ],
          },
        ],
        guidingQuestions: [
          'What is your infrastructure growth rate YoY?',
          'Do you expect significant changes in cloud spend in the next 12 months?',
          'What is your monthly infrastructure operations budget?',
          'Are you planning cloud migrations or modernization efforts?',
          'Do you have CapEx or OpEx budget constraints?',
        ],
      },
    ],
  },
  development: {
    ...
    questions: [
      ...
      {
        id: 'development_sizing',
        title: 'Development & DevOps Sizing',
        description: 'Provide team and deployment sizing for accurate recommendations',
        type: 'vendor_multi',
        categories: [
          {
            key: 'team_sizing',
            name: '👥 Team & Developer Sizing',
            vendors: [
              { label: 'Number of developers: < 10', value: 'devs_10' },
              { label: 'Number of developers: 10-50', value: 'devs_50' },
              { label: 'Number of developers: 50-200', value: 'devs_200' },
              { label: 'Number of developers: > 200', value: 'devs_200plus' },
              { label: 'Number of DevOps/SRE engineers: < 5', value: 'devops_5' },
              { label: 'Number of DevOps/SRE engineers: 5-20', value: 'devops_20' },
              { label: 'Number of DevOps/SRE engineers: > 20', value: 'devops_20plus' },
              { label: 'Number of QA engineers: < 5', value: 'qa_5' },
              { label: 'Number of QA engineers: 5-20', value: 'qa_20' },
              { label: 'Number of QA engineers: > 20', value: 'qa_20plus' },
            ],
          },
          {
            key: 'codebase_sizing',
            name: '💾 Codebase & Repository Sizing',
            vendors: [
              { label: 'Number of code repositories: < 10', value: 'repos_10' },
              { label: 'Number of code repositories: 10-50', value: 'repos_50' },
              { label: 'Number of code repositories: 50-200', value: 'repos_200' },
              { label: 'Number of code repositories: > 200', value: 'repos_200plus' },
              { label: 'Average lines of code per service: < 10k LOC', value: 'loc_10k' },
              { label: 'Average lines of code per service: 10k-100k LOC', value: 'loc_100k' },
              { label: 'Average lines of code per service: > 100k LOC', value: 'loc_100kplus' },
              { label: 'Number of microservices: < 10', value: 'services_10' },
              { label: 'Number of microservices: 10-50', value: 'services_50' },
              { label: 'Number of microservices: > 50', value: 'services_50plus' },
            ],
          },
          {
            key: 'deployment_sizing',
            name: '🚀 Deployment & Pipeline Sizing',
            vendors: [
              { label: 'Number of production deployments per day: < 10', value: 'deploy_10' },
              { label: 'Number of production deployments per day: 10-50', value: 'deploy_50' },
              { label: 'Number of production deployments per day: > 50', value: 'deploy_50plus' },
              { label: 'Number of CI/CD pipeline executions per day: < 100', value: 'pipeline_100' },
              { label: 'Number of CI/CD pipeline executions per day: 100-1000', value: 'pipeline_1000' },
              { label: 'Number of CI/CD pipeline executions per day: > 1000', value: 'pipeline_1000plus' },
              { label: 'Average build time: < 5 minutes', value: 'build_5' },
              { label: 'Average build time: 5-15 minutes', value: 'build_15' },
              { label: 'Average build time: > 15 minutes', value: 'build_15plus' },
            ],
          },
          {
            key: 'testing_sizing',
            name: '✅ Testing & Quality Sizing',
            vendors: [
              { label: 'Automated test coverage: < 50%', value: 'coverage_50' },
              { label: 'Automated test coverage: 50-80%', value: 'coverage_80' },
              { label: 'Automated test coverage: > 80%', value: 'coverage_80plus' },
              { label: 'Average tests executed per build: < 1000', value: 'tests_1000' },
              { label: 'Average tests executed per build: 1000-10000', value: 'tests_10000' },
              { label: 'Average tests executed per build: > 10000', value: 'tests_10000plus' },
            ],
          },
        ],
        guidingQuestions: [
          'What is your developer productivity bottleneck today?',
          'What is your estimated DevOps/platform engineering budget?',
          'Are you planning to scale development teams in the next year?',
          'What are your deployment frequency and reliability targets?',
          'How many production incidents do you experience monthly?',
        ],
      },
    ],
  },
  data: {
    ...
    questions: [
      ...
      {
        id: 'data_sizing',
        title: 'Data Infrastructure Sizing & Licensing',
        description: 'Provide data platform sizing for licensing and cost calculations',
        type: 'vendor_multi',
        categories: [
          {
            key: 'data_volume',
            ...
            vendors: [
              { label: 'Current data warehouse size: < 1 TB', value: 'dw_1tb' },
              { label: 'Current data warehouse size: 1-10 TB', value: 'dw_10tb' },
              { label: 'Current data warehouse size: 10-100 TB', value: 'dw_100tb' },
              { label: 'Current data warehouse size: > 100 TB', value: 'dw_100tbplus' },
              { label: 'Monthly data ingestion rate: < 10 GB', value: 'ingest_10gb' },
              { label: 'Monthly data ingestion rate: 10-100 GB', value: 'ingest_100gb' },
              { label: 'Monthly data ingestion rate: 100 GB - 1 TB', value: 'ingest_1tb' },
              { label: 'Monthly data ingestion rate: > 1 TB', value: 'ingest_1tbplus' },
              { label: 'Data retention: < 1 year', value: 'retention_1y' },
              { label: 'Data retention: 1-3 years', value: 'retention_3y' },
              { label: 'Data retention: 3-7 years', value: 'retention_7y' },
              { label: 'Data retention: > 7 years', value: 'retention_7yplus' },
            ],
          },
          {
            key: 'user_analytics',
            name: '👥 Analytics Users & Consumption',
            vendors: [
              { label: 'Analytics business users: < 10', value: 'users_10' },
              { label: 'Analytics business users: 10-50', value: 'users_50' },
              { label: 'Analytics business users: 50-200', value: 'users_200' },
              { label: 'Analytics business users: > 200', value: 'users_200plus' },
              { label: 'Data analysts/engineers: < 5', value: 'analysts_5' },
              { label: 'Data analysts/engineers: 5-20', value: 'analysts_20' },
              { label: 'Data analysts/engineers: > 20', value: 'analysts_20plus' },
              { label: 'Number of active dashboards: < 20', value: 'dash_20' },
              { label: 'Number of active dashboards: 20-100', value: 'dash_100' },
              { label: 'Number of active dashboards: > 100', value: 'dash_100plus' },
            ],
          },
          {
            key: 'compute_resources',
            name: '⚙️ Compute & Resource Utilization',
            vendors: [
              { label: 'Peak concurrent queries: < 10', value: 'queries_10' },
              { label: 'Peak concurrent queries: 10-50', value: 'queries_50' },
              { label: 'Peak concurrent queries: 50-100', value: 'queries_100' },
              { label: 'Peak concurrent queries: > 100', value: 'queries_100plus' },
              { label: 'Average query execution time: < 1 minute', value: 'query_1m' },
              { label: 'Average query execution time: 1-10 minutes', value: 'query_10m' },
              { label: 'Average query execution time: > 10 minutes', value: 'query_10mplus' },
              { label: 'Number of ETL jobs per day: < 10', value: 'jobs_10' },
              { label: 'Number of ETL jobs per day: 10-50', value: 'jobs_50' },
              { label: 'Number of ETL jobs per day: > 50', value: 'jobs_50plus' },
            ],
          },
          {
            key: 'ml_ai_usage',
            name: '🤖 ML/AI & Advanced Analytics',
            vendors: [
              { label: 'ML models in production: 0', value: 'ml_0' },
              { label: 'ML models in production: 1-5', value: 'ml_5' },
              { label: 'ML models in production: 5-20', value: 'ml_20' },
              { label: 'ML models in production: > 20', value: 'ml_20plus' },
              { label: 'Data scientists on staff: 0', value: 'ds_0' },
              { label: 'Data scientists on staff: 1-3', value: 'ds_3' },
              { label: 'Data scientists on staff: 3-10', value: 'ds_10' },
              { label: 'Data scientists on staff: > 10', value: 'ds_10plus' },
            ],
          },
        ],
        guidingQuestions: [
          'What is your data platform annual budget?',
          'Are you planning to increase data volume or user adoption in the next year?',
          'What is your pricing model preference (per GB, per user, per compute)?',
          'Do you require guaranteed query performance/SLAs?',
          'Are you considering real-time analytics or batch only?',
        ],
      },
    ],
  },
  ai: {
    ...
    questions: [
      {
        id: 'llm_platforms',
        title: 'LLM Platforms & AI Services',
        description: 'Select the large language model platforms and AI services you use',
        type: 'vendor_multi',
        categories: [
          {
            key: 'foundational_llms',
            name: '🧠 Foundational LLM Platforms',
            vendors: [
              { label: 'OpenAI (ChatGPT, GPT-4)', value: 'openai' },
              { label: 'OpenAI Enterprise (ChatGPT Enterprise)', value: 'openai_enterprise' },
              { label: 'Anthropic Claude (Claude 3, Claude Instant)', value: 'anthropic' },
              { label: 'Google Gemini (formerly Bard)', value: 'google_gemini' },
              { label: 'Meta Llama 2/3', value: 'meta_llama' },
              { label: 'Mistral AI', value: 'mistral' },
              { label: 'xAI Grok', value: 'grok' },
              { label: 'Cohere Command', value: 'cohere' },
              { label: 'AI21 Labs Jurassic', value: 'ai21' },
              { label: 'Aleph Alpha Luminous', value: 'aleph_alpha' },
            ],
          },
          {
            key: 'ai_platforms',
            ...
            vendors: [
              { label: 'Azure OpenAI Service', value: 'azure_openai' },
              { label: 'AWS Bedrock', value: 'aws_bedrock' },
              { label: 'Google Cloud Vertex AI', value: 'vertex_ai' },
              { label: 'HuggingFace', value: 'huggingface' },
              { label: 'Together AI', value: 'together_ai' },
              { label: 'Replicate', value: 'replicate' },
              { label: 'Modal', value: 'modal' },
              { label: 'Lambda Labs', value: 'lambda_labs' },
            ],
          },
          {
            ...
            vendors: [
              ...
              { label: 'LanceDB', value: 'lancedb' },
              { label: 'Vespa', value: 'vespa' },
              { label: 'OpenSearch with Vector', value: 'opensearch_vector' },
            ],
          },
          {
            key: 'ai_agents_frameworks',
            name: '🔗 AI Agents & Orchestration',
            vendors: [
              { label: 'LangChain', value: 'langchain' },
              { label: 'LlamaIndex', value: 'llamaindex' },
              { label: 'AutoGPT', value: 'autogpt' },
              { label: 'BabyAGI', value: 'babyagi' },
              { label: 'Semantic Kernel', value: 'semantic_kernel' },
          ...
          {
            key: 'ai_governance',
            name: '🛡️ AI Governance & Safety',
            vendors: [
              { label: 'Anthropic Constitutional AI', value: 'constitutional_ai' },
              { label: 'OpenAI Moderation API', value: 'openai_moderation' },
              { label: 'Truera TrueLens', value: 'truera' },
              { label: 'Arthur AI', value: 'arthur_ai' },
              { label: 'WhyLabs', value: 'whylabs' },
              { label: 'Arize AI', value: 'arize_ai' },
              { label: 'Robust Intelligence', value: 'robust_intelligence' },
              { label: 'Fiddler AI', value: 'fiddler_ai' },
            ],
          },
        ],
        guidingQuestions: [
          'Are you using public APIs, private deployments, or self-hosted LLMs?',
          'Do you require data privacy/residency compliance (SOC2, GDPR, HIPAA)?',
          'Are you building user-facing AI applications or internal tools?',
      ...
      {
        id: 'ai_applications',
        title: 'AI Applications & Use Cases',
        description: 'Select the AI applications and use cases being implemented',
        type: 'vendor_multi',
        categories: [
          {
            key: 'customer_facing',
            ...
            vendors: [
              { label: 'Chatbots & Virtual Assistants', value: 'chatbots' },
              { label: 'Generative Customer Service', value: 'gen_support' },
              { label: 'Recommendation Engines', value: 'recommendations' },
              { label: 'Content Generation (Marketing/Product)', value: 'content_gen' },
              { label: 'Personalization', value: 'personalization' },
              { label: 'Predictive Analytics', value: 'predictive' },
            ],
          },
          {
            key: 'enterprise_internal',
            name: '🏢 Enterprise Internal Applications',
            vendors: [
              { label: 'Document Summarization', value: 'doc_summary' },
              { label: 'Code Generation & Copilots', value: 'code_gen' },
              { label: 'Business Process Automation', value: 'process_auto' },
              { label: 'Data Analysis & Insights', value: 'data_analysis' },
              { label: 'Search & Discovery', value: 'search' },
              { label: 'Knowledge Management', value: 'knowledge_mgmt' },
            ],
          },
          {
            key: 'specialized_ai',
            ...
            vendors: [
              { label: 'Image Generation (DALL-E, Midjourney, Stable Diffusion)', value: 'image_gen' },
              { label: 'Audio Transcription & Generation', value: 'audio' },
              { label: 'Video Analysis & Generation', value: 'video' },
              { label: 'Anomaly Detection', value: 'anomaly' },
              { label: 'Fraud Detection', value: 'fraud_detection' },
              { label: 'Entity Recognition & NLP', value: 'nlp' },
            ],
          },
        ],
        guidingQuestions: [
          'What business problems are you trying to solve with AI?',
          'Are these pilot projects or production deployments?',
          'What is your expected ROI or business impact?',
          'Do you have a dedicated AI/ML team or are you using managed services?',
      ...
      },
      {
        ...
        description: 'Select your AI infrastructure and deployment technologies',
        type: 'vendor_multi',
        categories: [
          {
            key: 'gpu_compute',
            name: '⚙️ GPU & Compute Resources',
            vendors: [
              { label: 'NVIDIA GPUs (H100, A100, RTX)', value: 'nvidia_gpu' },
              { label: 'AMD Instinct GPUs', value: 'amd_gpu' },
              { label: 'Google TPUs', value: 'google_tpu' },
              { label: 'AWS Trainium/Inferentia', value: 'aws_chip' },
              { label: 'Apple Silicon (M1/M2/M3)', value: 'apple_silicon' },
              { label: 'Custom silicon (Groq, Cerebras)', value: 'custom_silicon' },
              { label: 'CPU-only inference', value: 'cpu_only' },
            ],
          },
          {
            key: 'model_serving',
            ...
            vendors: [
              ...
              { label: 'TensorRT-LLM', value: 'tensorrt_llm' },
              { label: 'Ray Serve', value: 'ray_serve' },
              { label: 'KServe', value: 'kserve' },
              { label: 'Triton Inference Server', value: 'triton' },
              { label: 'BentoML', value: 'bentoml' },
              { label: 'Seldon Core', value: 'seldon' },
            ],
          },
          {
            key: 'ml_ops',
            ...
            vendors: [
              ...
              { label: 'Neptune.ai', value: 'neptune' },
              { label: 'Databricks MLflow', value: 'databricks_ml' },
              { label: 'SageMaker Model Registry', value: 'sagemaker_registry' },
              { label: 'Hugging Face Model Hub', value: 'hf_model_hub' },
              { label: 'Verta Platform', value: 'verta' },
            ],
          },
          {
            key: 'monitoring_eval',
            name: '📊 AI Monitoring & Evaluation',
            vendors: [
              { label: 'Evidently AI', value: 'evidently' },
              { label: 'DeepChecks', value: 'deepchecks' },
              { label: 'Giskard', value: 'giskard' },
              { label: 'Superwise', value: 'superwise' },
              { label: 'Fiddler', value: 'fiddler' },
              { label: 'Humanloop', value: 'humanloop' },
              { label: 'HELM (Stanford)', value: 'helm_stanford' },
            ],
          },
        ],
        guidingQuestions: [
          'Are you running models on-premises, cloud, or hybrid?',
          'What is your current GPU/compute capacity utilization?',
          'Do you need real-time serving or batch inference?',
          'What is your SLA for model latency and availability?',
          'How are you monitoring model performance in production?',
        ],
      },
      {
        id: 'ai_sizing',
        title: 'AI/LLM Sizing & Licensing',
        description: 'Provide AI infrastructure and licensing details for accurate recommendations',
        type: 'vendor_multi',
        categories: [
          {
            key: 'llm_usage',
            name: '🔢 LLM Usage & Consumption',
            vendors: [
              { label: 'Monthly API calls: < 100k', value: 'calls_100k' },
              { label: 'Monthly API calls: 100k-1M', value: 'calls_1m' },
              { label: 'Monthly API calls: 1M-10M', value: 'calls_10m' },
              { label: 'Monthly API calls: > 10M', value: 'calls_10mplus' },
              { label: 'Monthly tokens: < 1B', value: 'tokens_1b' },
              { label: 'Monthly tokens: 1B-10B', value: 'tokens_10b' },
              { label: 'Monthly tokens: 10B-100B', value: 'tokens_100b' },
              { label: 'Monthly tokens: > 100B', value: 'tokens_100bplus' },
            ],
          },
          {
            ...
            vendors: [
              { label: 'Number of AI applications: 1-5', value: 'apps_5' },
              { label: 'Number of AI applications: 5-20', value: 'apps_20' },
              { label: 'Number of AI applications: 20+', value: 'apps_20plus' },
              { label: 'Number of concurrent AI users: < 100', value: 'users_100' },
              { label: 'Number of concurrent AI users: 100-1000', value: 'users_1000' },
              { label: 'Number of concurrent AI users: > 1000', value: 'users_1000plus' },
              { label: 'Number of custom models: < 5', value: 'models_5' },
              { label: 'Number of custom models: 5-20', value: 'models_20' },
              { label: 'Number of custom models: > 20', value: 'models_20plus' },
            ],
          },
          {
            key: 'infrastructure_requirements',
            name: '⚙️ Infrastructure Requirements',
            vendors: [
              { label: 'Number of GPUs deployed: 0', value: 'gpu_0' },
              { label: 'Number of GPUs deployed: 1-10', value: 'gpu_10' },
              { label: 'Number of GPUs deployed: 10-50', value: 'gpu_50' },
              { label: 'Number of GPUs deployed: > 50', value: 'gpu_50plus' },
              { label: 'Model size: < 7B parameters', value: 'size_7b' },
              { label: 'Model size: 7B-70B parameters', value: 'size_70b' },
              { label: 'Model size: 70B-500B parameters', value: 'size_500b' },
              { label: 'Model size: > 500B parameters', value: 'size_500bplus' },
            ],
          },
          {
            ...
            vendors: [
              { label: 'Required inference latency: < 100ms', value: 'latency_100ms' },
              { label: 'Required inference latency: 100-500ms', value: 'latency_500ms' },
              { label: 'Required inference latency: 500ms-2s', value: 'latency_2s' },
              { label: 'Required inference latency: > 2s (batch ok)', value: 'latency_batch' },
              { label: 'Monthly AI/ML budget: < $10k', value: 'budget_10k' },
              { label: 'Monthly AI/ML budget: $10k-$50k', value: 'budget_50k' },
              { label: 'Monthly AI/ML budget: $50k-$500k', value: 'budget_500k' },
              { label: 'Monthly AI/ML budget: > $500k', value: 'budget_500kplus' },
            ],
          },
        ],
        guidingQuestions: [
          'What is your expected ROI on AI investments?',
          'Do you have a dedicated AI budget or is it part of general IT?',
          'Are you planning to increase AI spending in the next 12 months?',
          'What is your data privacy/security requirements for AI?',
          'Do you plan to move to self-hosted or keep using APIs?',
        ],
      },
    ],
  },
